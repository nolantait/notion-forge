...
export var PageTitle = function (_a) {
    ...
    var _e = useNotionContext(), recordMap = _e.recordMap, components = _e.components;
    if (!block)
        return null;
    ...
    return (React.createElement("span", __assign({ className: cs("notion-page-title", className) }, rest),
        React.createElement(components.pageIcon, { block: block, defaultIcon: defaultIcon, className: "notion-page-title-icon" }),
