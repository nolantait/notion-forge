...
// const Linkable = Mixins.Linkable(
//   Mixins.Captionable(Mixins.Colorable(Mixins.Titleable(Block)))
// );
// const Pageable = Mixins.Glyphable(
//   Mixins.Lockable(Mixins.Layoutable(Mixins.Colorable(Mixins.Titleable(Block))))
// );
// const Iconable = Mixins.Glyphable(Mixins.Colorable(Mixins.Titleable(Block)));
// const Captionable = Mixins.Captionable(
//   Mixins.Colorable(Mixins.Titleable(Block))
// );
